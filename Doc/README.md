...
- [How to capture](/Doc/HowToCapture.md) - How to capture, study, and analyze information sent to and from EMO.
- [Our assumptions](/Doc/Assumptions.md) - Various assumptions we have made, aka educated guesses.
